...
export const archiveImages: ReadonlyArray<ArchiveImage> = [
  ...
  // ─── Egypt / Alexander / Peloponnesian supercluster ──────────────────
  {
    slug: "senusret-iii-statue",
    kind: "artifact",
    subject: "Statue of the Middle Kingdom pharaoh Senusret III",
    culture: "egyptian",
    era: "Middle Kingdom, Twelfth Dynasty, c. 1850 BCE",
    location: "British Museum, London",
    source: "https://commons.wikimedia.org/wiki/File:Statues_of_Senusret_III,_British_Museum_01.jpg",
    license: "cc-zero",
    photographer: "14GTR",
    imagePath: "/images/artifacts/senusret-iii-statue.webp",
    width: 1600,
    height: 1418,
    alt: "A granite statue of the Middle Kingdom pharaoh Senusret III, the careworn, heavy-lidded royal face that marks the era's new ideal of the king as a burdened shepherd of his people.",
    caption: "Senusret III · Middle Kingdom, c. 1850 BCE · Granite",
    attribution: "British Museum · Wikimedia Commons (CC0)",
    notes:
      "Vendored for the Middle Kingdom hub (hero). The brooding portraits of Senusret III express the Middle Kingdom's new conception of kingship as responsibility weighed in the king's own face. British Museum, CC0.",
  },
  {
    slug: "saqqara-step-pyramid",
    kind: "architecture",
    subject: "The Step Pyramid of Djoser at Saqqara",
    culture: "egyptian",
    era: "Old Kingdom, Third Dynasty, c. 2670 BCE",
    ...
    imagePath: "/images/architecture/saqqara-step-pyramid.webp",
    width: 1600,
    height: 1067,
    alt: "The six-stepped Step Pyramid of Djoser rising in tiers above the desert at Saqqara — the world's earliest large stone building.",
    caption: "Step Pyramid of Djoser, Saqqara · c. 2670 BCE · Limestone",
    attribution: "Saqqara · photo V. Argenberg · Wikimedia Commons (CC BY 4.0)",
    notes:
      "Vendored for the Old Kingdom hub. The first monumental stone structure in history and the ancestor of the true pyramids; the opening statement of Egyptian monumentality. Licensed CC BY 4.0.",
  },
  {
    slug: "great-sphinx-giza",
    kind: "architecture",
    subject: "The Great Sphinx of Giza",
    culture: "egyptian",
    era: "Old Kingdom, Fourth Dynasty, c. 2500 BCE",
    location: "Giza, Egypt",
    source: "https://commons.wikimedia.org/wiki/File:Great_Sphinx_of_Giza_(2).jpg",
    license: "cc-by-sa",
    photographer: "Hamerani",
    imagePath: "/images/architecture/great-sphinx-giza.webp",
    width: 1600,
    height: 1068,
    alt: "The Great Sphinx of Giza, the colossal recumbent lion with a human royal head carved from the living rock, with a pyramid behind it.",
    caption: "Great Sphinx of Giza · Old Kingdom, c. 2500 BCE · Limestone",
    attribution: "Giza · photo Hamerani · Wikimedia Commons (CC BY-SA 4.0)",
    notes:
      "Vendored for the Old Kingdom and Egypt hubs. The colossal guardian of the Giza necropolis, an Old Kingdom monument of the era of the pyramid-builders. Licensed CC BY-SA 4.0.",
  },
  {
    slug: "narmer-palette",
    kind: "relief",
    subject: "The Narmer Palette",
    culture: "egyptian",
    era: "Early Dynastic Period, c. 3100 BCE",
    location: "Egyptian Museum, Cairo",
    source: "https://commons.wikimedia.org/wiki/File:Narmer_Palette.jpg",
    license: "public-domain",
    photographer: "anonymous",
    imagePath: "/images/artifacts/narmer-palette.webp",
    width: 1600,
    height: 1127,
    alt: "The Narmer Palette, a carved slate ceremonial palette showing the king Narmer in the white crown smiting an enemy — one of the founding documents of the Egyptian state.",
    caption: "Narmer Palette · Early Dynastic, c. 3100 BCE · Slate",
    attribution: "Egyptian Museum, Cairo · Wikimedia Commons (public domain)",
    notes:
      "Vendored for the Egypt and Old Kingdom hubs. One of the earliest historical documents of Egypt, traditionally read as commemorating the unification of Upper and Lower Egypt and the founding of the pharaonic state. Public domain by age.",
  },
  {
    slug: "hatshepsut-temple",
    kind: "architecture",
    subject: "The mortuary temple of Hatshepsut at Deir el-Bahari",
    culture: "egyptian",
    era: "New Kingdom, Eighteenth Dynasty, c. 1470 BCE",
    location: "Deir el-Bahari, Thebes (Luxor), Egypt",
    source: "https://commons.wikimedia.org/wiki/File:Thebes,_Luxor,_Egypt,_Temple_of_Hatshepsut,_Deir_el-Bahari.jpg",
    license: "cc-by",
    photographer: "Vyacheslav Argenberg",
    imagePath: "/images/architecture/hatshepsut-temple.webp",
    width: 1600,
    height: 1067,
    alt: "The terraced mortuary temple of Hatshepsut rising in colonnaded tiers against the sheer cliffs of Deir el-Bahari.",
    caption: "Mortuary temple of Hatshepsut, Deir el-Bahari · c. 1470 BCE",
    attribution: "Deir el-Bahari · photo V. Argenberg · Wikimedia Commons (CC BY 4.0)",
    notes:
      "Vendored for the New Kingdom hub and the Hatshepsut figure. One of the most original and beautiful works of Egyptian architecture, the monument of a woman who ruled as king. Licensed CC BY 4.0.",
  },
  {
    slug: "luxor-temple",
    kind: "architecture",
    subject: "Luxor Temple, the great pylon and colossi",
    culture: "egyptian",
    era: "New Kingdom, largely Eighteenth–Nineteenth Dynasties",
    ...
    imagePath: "/images/architecture/luxor-temple.webp",
    width: 1600,
    height: 964,
    alt: "The great pylon of Luxor Temple, fronted by colossal seated statues of Ramesses II and a standing obelisk.",
    caption: "Luxor Temple, the great pylon · New Kingdom",
    attribution: "Luxor · photo Marc Ryckaert · Wikimedia Commons (CC BY 3.0)",
    notes:
      "Vendored for the New Kingdom and Egypt hubs. A great Theban temple expanded by the New Kingdom pharaohs, its pylon adorned by Ramesses II. Licensed CC BY 3.0.",
  },
  {
    slug: "abu-simbel",
    kind: "architecture",
    subject: "The Great Temple of Abu Simbel",
    culture: "egyptian",
    era: "New Kingdom, reign of Ramesses II, c. 1264 BCE",
    location: "Abu Simbel, Nubia, Egypt",
    source: "https://commons.wikimedia.org/wiki/File:The_great_temple_of_Abu_simbel..JPG",
    license: "cc-by-sa",
    photographer: "Abumalek ahmed mohamed",
    imagePath: "/images/architecture/abu-simbel.webp",
    width: 1600,
    height: 1200,
    alt: "The facade of the Great Temple of Abu Simbel, cut from the cliff and fronted by four colossal seated statues of Ramesses II.",
    caption: "Great Temple of Abu Simbel · Ramesses II, c. 1264 BCE",
    attribution: "Abu Simbel · Wikimedia Commons (CC BY-SA 4.0)",
    notes:
      "Vendored for the New Kingdom hub and the Ramesses II figure. The colossal rock temple, its four sixty-foot figures of the king, is the supreme image of Ramesside monumentality. Licensed CC BY-SA 4.0.",
  },
  {
    slug: "karnak-obelisk-hatshepsut",
    kind: "architecture",
    subject: "The obelisk of Hatshepsut at Karnak",
    culture: "egyptian",
    era: "New Kingdom, Eighteenth Dynasty, c. 1470 BCE",
    location: "Karnak temple complex, Luxor, Egypt",
    source: "https://commons.wikimedia.org/wiki/File:Karnak_Temple_Obelisk_(9794685624).jpg",
    license: "cc-zero",
    photographer: "Gary Todd",
    imagePath: "/images/architecture/karnak-obelisk-hatshepsut.webp",
    width: 1600,
    height: 1089,
    alt: "A tall granite obelisk standing among the columns and walls of the Karnak temple complex, raised by the pharaoh Hatshepsut.",
    caption: "Obelisk of Hatshepsut, Karnak · c. 1470 BCE · Granite",
    attribution: "Karnak, Luxor · photo Gary Todd · Wikimedia Commons (CC0)",
    notes:
      "Vendored for the New Kingdom hub and the Hatshepsut figure. One of the tallest surviving ancient obelisks, raised by Hatshepsut at the great temple of Amun. CC0.",
  },
  {
    slug: "valley-of-the-kings",
    kind: "ruins",
    subject: "The Valley of the Kings, Thebes",
    culture: "egyptian",
    era: "New Kingdom royal necropolis, c. 1539–1075 BCE",
    ...
    license: "cc-by",
    photographer: "Vyacheslav Argenberg",
    imagePath: "/images/ruins/valley-of-the-kings.webp",
    width: 1600,
    height: 1067,
    alt: "Panoramic view of the arid, cliff-walled Valley of the Kings, the burial ground of the New Kingdom pharaohs, with tomb entrances cut into the rock.",
    caption: "Valley of the Kings, Thebes · New Kingdom royal necropolis",
    attribution: "Luxor · photo V. Argenberg · Wikimedia Commons (CC BY 4.0)",
    notes:
      "Vendored for the New Kingdom hub. The rock-cut royal necropolis of the New Kingdom, where the imperial pharaohs from Thutmose to Ramesses were buried. Licensed CC BY 4.0.",
  },
  {
    slug: "trireme-olympias",
    kind: "artifact",
    subject: "The reconstructed Athenian trireme Olympias",
    culture: "greek",
    era: "modern full-scale reconstruction of a 5th-century-BCE warship",
    location: "Faliro, Athens, Greece",
    source: "https://commons.wikimedia.org/wiki/File:The_trireme_Olympias_on_23_February_2019.jpg",
    license: "cc-by-sa",
    photographer: "George E. Koronaios",
    imagePath: "/images/artifacts/trireme-olympias.webp",
    width: 1600,
    height: 1066,
    alt: "The Olympias, a modern full-scale reconstruction of an ancient Athenian trireme, its three banks of oars and bronze ram visible, afloat at Athens.",
    caption: "Trireme Olympias · modern reconstruction of a 5th-c. BCE warship",
    attribution: "Faliro, Athens · photo G. E. Koronaios · Wikimedia Commons (CC BY-SA 4.0)",
    notes:
      "Vendored for the Peloponnesian War layer and the naval-empire theme. A modern reconstruction (not an ancient artefact), captioned as such, that makes the warship on which Athenian sea power rested visible. Licensed CC BY-SA 4.0.",
  },

  // ─── Plato / Aristotle deepening ─────────────────────────────────────
  {
    slug: "school-of-athens",
    kind: "painting",
    subject: "Raphael's The School of Athens",
    culture: "modern",
    era: "Italian Renaissance fresco (1509–1511), depicting the ancient philosophers",
    location: "Stanze di Raffaello, Apostolic Palace, Vatican",
    source: "https://commons.wikimedia.org/wiki/File:Raphael_School_of_Athens.jpg",
    license: "public-domain",
    photographer: "Raphael",
    imagePath: "/images/artifacts/school-of-athens.webp",
    width: 1600,
    height: 1045,
    alt: "Raphael's fresco The School of Athens, the gathering of the ancient philosophers, with Plato pointing upward and Aristotle gesturing toward the earth at its centre.",
    caption: "The School of Athens · Raphael · 1509–1511 (Renaissance fresco)",
    attribution: "Vatican · Raphael · Wikimedia Commons (public domain)",
    notes:
      "Vendored for the Plato and Aristotle clusters. A Renaissance fresco — not an ancient image — used and captioned as such; the iconic depiction of the two philosophers, Plato pointing to the heavens and Aristotle to the earth. Public domain by age.",
  },
  {
    slug: "platos-academy-mosaic",
    kind: "mosaic",
    subject: "Plato's Academy, Roman mosaic from Pompeii",
    culture: "roman",
    era: "Roman, 1st century BCE – 1st century CE",
    location: "National Archaeological Museum, Naples (from Pompeii)",
    source: "https://commons.wikimedia.org/wiki/File:Plato%27s_Academy_mosaic_from_Pompeii.jpg",
    license: "public-domain",
    photographer: "Roman mosaicist",
    imagePath: "/images/artifacts/platos-academy-mosaic.webp",
    width: 1563,
    height: 1600,
    alt: "A Roman mosaic from Pompeii showing a group of philosophers gathered in discussion beneath a tree, traditionally identified as Plato's Academy.",
    caption: "Plato's Academy · Roman mosaic, Pompeii · 1st c. BCE–CE",
    attribution: "National Archaeological Museum, Naples · Wikimedia Commons (public domain)",
    notes:
      "Vendored for the Plato cluster and the Academy material. An ancient Roman mosaic depicting philosophers, traditionally read as Plato's Academy; one of the few ancient images of the philosophical school. Public domain by age.",
  },
  {
    slug: "plato-academy-site",
    kind: "ruins",
    subject: "The archaeological site of Plato's Academy, Athens",
    culture: "greek",
    era: "the Academy active c. 387 BCE – 86 BCE; site remains",
    location: "Akadimia Platonos, Athens",
    source: "https://commons.wikimedia.org/wiki/File:Athens_Plato_Academy_Archaeological_Site_1.jpg",
    license: "cc-by-sa",
    photographer: "Tomisti",
    imagePath: "/images/ruins/plato-academy-site.webp",
    width: 1600,
    height: 1200,
    alt: "The archaeological site of Plato's Academy in Athens, low excavated foundations among grass and trees in the grove of Akademos.",
    caption: "Site of Plato's Academy · Athens",
    attribution: "Akadimia Platonos, Athens · photo Tomisti · Wikimedia Commons (CC BY-SA 3.0)",
    notes:
      "Vendored for the Plato cluster. The site of the school Plato founded in the grove of Akademos, which gave its name to every academy since. Licensed CC BY-SA 3.0.",
  },
  {
    slug: "aristotle-lyceum-site",
    kind: "ruins",
    subject: "The ruins of the Lyceum of Aristotle, Athens",
    culture: "greek",
    era: "the Lyceum active from 335 BCE; excavated remains",
    location: "Athens, Greece",
    source: "https://commons.wikimedia.org/wiki/File:The_ruins_of_the_Lyceum_of_Aristotle_on_February_3,_2021.jpg",
    license: "cc-by-sa",
    photographer: "George E. Koronaios",
    imagePath: "/images/ruins/aristotle-lyceum-site.webp",
    width: 1600,
    height: 1067,
    alt: "The excavated foundations of the Lyceum of Aristotle in central Athens, low walls and pathways of the ancient gymnasium and philosophical school.",
    caption: "Ruins of the Lyceum of Aristotle · Athens",
    attribution: "Athens · photo G. E. Koronaios · Wikimedia Commons (CC BY-SA 4.0)",
    notes:
      "Vendored for the Aristotle cluster. The site of the Lyceum, the school Aristotle founded, where he and his Peripatetic followers taught and gathered the empirical research of his vast corpus. Licensed CC BY-SA 4.0.",
  },
  {
    slug: "clarke-plato-manuscript",
    kind: "manuscripts",
    subject: "The Clarke Plato — a 9th-century manuscript of Plato's dialogues",
    culture: "byzantine",
    era: "Byzantine, copied 895 CE",
    location: "Bodleian Library, Oxford (MS. E. D. Clarke 39)",
    source: "https://commons.wikimedia.org/wiki/File:Apologia_beginning._Clarke_Plato.jpg",
    license: "public-domain",
    photographer: "Bodleian Library",
    imagePath: "/images/manuscripts/clarke-plato-manuscript.webp",
    width: 1063,
    height: 1600,
    alt: "A page of the Clarke Plato, a 9th-century Byzantine manuscript, showing the opening of Plato's Apology in Greek minuscule with marginal scholia.",
    caption: "The Clarke Plato · Byzantine manuscript, 895 CE · opening of the Apology",
    attribution: "Bodleian Library, Oxford · Wikimedia Commons (public domain)",
    notes:
      "Vendored for the Plato cluster and the dialogues. The Clarke Plato (Bodleian, copied 895 CE) is the oldest and most important manuscript for many of Plato's dialogues; the survival of the text depended on exactly such Byzantine copying. Public domain by age.",
  },

  // ─── Maps (historical-atlas and reference cartography) ────────────────
  {
    slug: "map-ancient-greece",
    kind: "maps",
    subject: "Map of Ancient Greece",
    culture: "modern",
    era: "from Shepherd's Historical Atlas (1911)",
    location: "William R. Shepherd, Historical Atlas",
    source: "https://commons.wikimedia.org/wiki/File:Ancient_greece_so_1926.jpg",
    license: "public-domain",
    photographer: "William R. Shepherd",
    imagePath: "/images/maps/map-ancient-greece.webp",
    width: 1600,
    height: 1208,
    alt: "A historical map of ancient Greece showing the city-states, regions and the Aegean, from Shepherd's Historical Atlas.",
    caption: "Ancient Greece · Shepherd's Historical Atlas (1911)",
    attribution: "W. R. Shepherd · Wikimedia Commons (public domain)",
    notes:
      "Vendored for the Maps layer (Ancient Greece). A public-domain reference map from Shepherd's Historical Atlas; modern cartography, not an ancient artefact.",
  },
  {
    slug: "map-athens-attica",
    kind: "maps",
    subject: "Map of Attica and Athens",
    culture: "modern",
    era: "from Shepherd's Historical Atlas (1911)",
    location: "William R. Shepherd, Historical Atlas",
    source: "https://commons.wikimedia.org/wiki/File:Attica_shepherd_p16.jpg",
    license: "public-domain",
    photographer: "William R. Shepherd",
    imagePath: "/images/maps/map-athens-attica.webp",
    width: 987,
    height: 1600,
    alt: "A historical map of Attica, the territory of Athens, showing the city, the Piraeus, the demes and the surrounding region.",
    caption: "Attica and Athens · Shepherd's Historical Atlas (1911)",
    attribution: "W. R. Shepherd · Wikimedia Commons (public domain)",
    notes:
      "Vendored for the Maps layer (Athens). Public-domain reference cartography of Attica from Shepherd's Historical Atlas.",
  },
  {
    slug: "map-sparta",
    kind: "maps",
    subject: "Map of Spartan territory before 371 BCE",
    culture: "modern",
    era: "modern historical map of the 5th–4th century BCE",
    location: "modern cartography",
    source: "https://commons.wikimedia.org/wiki/File:Spartan_Territory_Before_371_BC.png",
    license: "cc-by-sa",
    photographer: "T8612",
    imagePath: "/images/maps/map-sparta.webp",
    width: 1361,
    height: 1433,
    alt: "A map of the territory controlled by Sparta in the Peloponnese before the battle of Leuctra in 371 BCE, showing Laconia, Messenia and allied regions.",
    caption: "Spartan territory before 371 BCE · modern map",
    attribution: "modern map · T8612 · Wikimedia Commons (CC BY-SA 4.0)",
    notes:
      "Vendored for the Maps layer (Sparta). A modern historical map of Spartan-controlled territory at its height, before the loss of Messenia. Licensed CC BY-SA 4.0.",
  },
  {
    slug: "map-persian-empire",
    kind: "maps",
    subject: "Map of the Persian (Achaemenid) Empire",
    culture: "modern",
    era: "from Shepherd's Historical Atlas (1911)",
    location: "William R. Shepherd, Historical Atlas",
    source: "https://commons.wikimedia.org/wiki/File:Persian_empire.jpg",
    license: "public-domain",
    photographer: "William R. Shepherd",
    imagePath: "/images/maps/map-persian-empire.webp",
    width: 1314,
    height: 635,
    alt: "A historical map of the Achaemenid Persian Empire at its greatest extent, from the Aegean to the Indus, with its satrapies and royal roads.",
    caption: "The Persian Empire · Shepherd's Historical Atlas (1911)",
    attribution: "W. R. Shepherd · Wikimedia Commons (public domain)",
    notes:
      "Vendored for the Maps layer (Persian Empire). Public-domain reference map of the Achaemenid empire from Shepherd's Historical Atlas.",
  },
  {
    slug: "map-alexander-empire",
    kind: "maps",
    subject: "Map of the Empire of Alexander the Great",
    culture: "modern",
    era: "from Shepherd's Historical Atlas (the conquests of 336–323 BCE)",
    location: "William R. Shepherd, Historical Atlas",
    source: "https://commons.wikimedia.org/wiki/File:Macedonian_empire_336_323.jpg",
    license: "public-domain",
    photographer: "William R. Shepherd",
    imagePath: "/images/maps/map-alexander-empire.webp",
    width: 1600,
    height: 842,
    alt: "A historical map of the empire of Alexander the Great, tracing his route of conquest from Macedon to the Indus, with the major battles marked.",
    caption: "The Empire of Alexander · Shepherd's Historical Atlas",
    attribution: "W. R. Shepherd · Wikimedia Commons (public domain)",
    notes:
      "Vendored for the Maps layer (Alexander's Empire). Public-domain reference map of Alexander's conquests from Shepherd's Historical Atlas.",
  },
  {
    slug: "map-roman-republic",
    kind: "maps",
    subject: "Map of Ancient Italy (the Roman Republic's heartland)",
    culture: "modern",
    era: "from Shepherd's Historical Atlas (1911)",
    location: "William R. Shepherd, Historical Atlas",
    source: "https://commons.wikimedia.org/wiki/File:Map_of_Ancient_Italy,_Southern_Part.jpg",
    license: "public-domain",
    photographer: "William R. Shepherd",
    imagePath: "/images/maps/map-roman-republic.webp",
    width: 1600,
    height: 1328,
    alt: "A historical map of ancient Italy, the heartland from which the Roman Republic expanded, showing the peoples, roads and colonies of the peninsula.",
    caption: "Ancient Italy · Shepherd's Historical Atlas (1911)",
    attribution: "W. R. Shepherd · Wikimedia Commons (public domain)",
    notes:
      "Vendored for the Maps layer (Roman Republic). Public-domain reference map of ancient Italy, the base of the Republic's expansion, from Shepherd's Historical Atlas.",
  },
  {
    slug: "map-roman-empire",
    kind: "maps",
    subject: "Map of the Roman Empire under Trajan (117 CE)",
    culture: "modern",
    era: "modern map of the empire at its greatest extent, 117 CE",
    location: "modern cartography",
    source: "https://commons.wikimedia.org/wiki/File:Map_of_the_Roman_Empire_during_Trajan.png",
    license: "cc-zero",
    photographer: "Joyfulmapper",
    imagePath: "/images/maps/map-roman-empire.webp",
    width: 1600,
    height: 1231,
    alt: "A map of the Roman Empire at its greatest extent under Trajan in 117 CE, stretching from Britain to Mesopotamia around the Mediterranean.",
    caption: "The Roman Empire under Trajan, 117 CE · modern map",
    attribution: "modern map · Joyfulmapper · Wikimedia Commons (CC0)",
    notes:
      "Vendored for the Maps layer (Roman Empire). A clean modern reference map of the empire at its territorial peak. CC0.",
  },
  {
    slug: "map-egypt",
    kind: "maps",
    subject: "Map of New Kingdom Egypt",
    culture: "modern",
    era: "modern map of Egypt under Thutmose III, c. 1450 BCE",
    location: "modern cartography",
    source: "https://commons.wikimedia.org/wiki/File:Map_of_the_new_kingdom_of_egypt_in_1453_bc_under_pharaoh_thutmose_iii.png",
    license: "cc-zero",
    photographer: "Thutmose (Wikimedia user)",
    imagePath: "/images/maps/map-egypt.webp",
    width: 1392,
    height: 1600,
    alt: "A map of New Kingdom Egypt under Thutmose III, showing the Nile valley, the empire's reach into Nubia and the Levant, and the major cities.",
    caption: "New Kingdom Egypt under Thutmose III · modern map",
    attribution: "modern map · Wikimedia Commons (CC0)",
    notes:
      "Vendored for the Maps layer (Egypt). A clean modern reference map of Egypt at its imperial height in the New Kingdom. CC0.",
  },
  {
    slug: "map-mediterranean",
    kind: "maps",
    subject: "Map of Greek and Phoenician colonization of the Mediterranean",
    culture: "modern",
    era: "from Shepherd's Historical Atlas (the colonial world, c. 550 BCE)",
    location: "William R. Shepherd, Historical Atlas",
    source: "https://commons.wikimedia.org/wiki/File:Greek_phoenician_550.jpg",
    license: "public-domain",
    photographer: "William R. Shepherd",
    imagePath: "/images/maps/map-mediterranean.webp",
    width: 1600,
    height: 962,
    alt: "A historical map of the Mediterranean world around 550 BCE, showing the spread of Greek and Phoenician colonies along its coasts.",
    caption: "The Mediterranean world · Greek and Phoenician colonies · Shepherd's Historical Atlas",
    attribution: "W. R. Shepherd · Wikimedia Commons (public domain)",
    notes:
      "Vendored for the Maps layer (Mediterranean World). Public-domain reference map of Greek and Phoenician colonization from Shepherd's Historical Atlas.",
  },
];
