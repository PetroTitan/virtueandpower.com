...
export const RELIGION_DEFERS_TO: ReadonlyArray<ReligionDeferral> = [
  ...
  },
  {
    ...
    reason:
      "The record states that the inner panels show the menorah and sacred vessels carried in 71 CE, cites Josephus — who was in Rome for the triumph, though he does not say he watched it — as the fullest contemporary description from the defeated side, and calls the panel the principal visual evidence for their appearance.",
  },
  {
...
export const CULT_PRACTICES: CultPractice[] = [
    ...
    keyPoints: [
      {
        ...
        detail:
          "Sacrificial calendar of the deme of Erchia (SEG 21.541; = LSCG 18; CGRN 52; Epigraphical Museum, Athens, EM 13163), a large fourth-century BC stele (A chance find near Spata in Attica, reported in the late 1940s and inventoried in the Epigraphical Museum, Athens, in 1952; first published in 1963; the deme of Erchia). A document of administration, not of doctrine.",
        level: "documented",
      },
      {
        claim: "When Athens formally codified its sacred obligations it codified rites, dates and expenditure, and that the resulting controversy — Lysias' surviving prosecution of Nikomachos — was about procedure and money.",
        detail:
      ...
      {
        claim: "The dedicant recorded the discharge of a vow.",
        detail:
  ...
  },
  {
    ...
    keyPoints: [
      ...
      {
        claim: "Pollution arising from death and killing was handled by prescribed, repeatable procedure, including rites for a person afflicted by an elasteros.",
        detail:
      ...
      {
        claim: "The boundary of sacred space was crossed through a physical act of sprinkling, matching the instruction in the inscribed entry rules.",
        detail:
  ...
  },
  {
    ...
    keyPoints: [
      {
        claim: "The accusations of 415 produced real convictions with real consequences, and what those consequences were: itemised auction of land, produce, slaves and household goods.",
        detail:
      ...
      {
        claim: "When the imperial state did impose a religious requirement on the population at large, it required and certified a performed act — sacrificing, tasting and pouring a libation before named commissioners who signed as witnesses.",
        detail:
  ...
  },
  {
    ...
    keyPoints: [
      ...
      {
        claim: "A major sanctuary composed and monumentally published narratives of divine intervention, on display in the area where patients slept — an act of institutional self-presentation, datable and physical.",
        detail:
  ...
  },
  {
    ...
    keyPoints: [
      ...
      {
        claim: "Recognition was sought in coordinated circuits, that mainland Greek bodies and Cretan cities were the target audiences, and that the campaign was entangled with Seleucid royal favour.",
        detail:
      ...
      {
        claim: "Inviolability was a widely competed-for civic and religious honour with a documented three-century arc, and that the surviving record is one of grants rather than of enforcement.",
        detail:
      ...
      {
        claim: "The ground on which protection could be claimed was physically defined and therefore contestable, extendable and reducible.",
        detail:
  ...
  },
  {
    ...
    keyPoints: [
      ...
      {
        claim: "Tablets, containers and figurines were deposited together as assemblages in a functioning water sanctuary over a long period, and that organic figurines — normally lost — were part of the practice.",
        detail:
  ...
  },
  {
    ...
    keyPoints: [
      {
        claim: "Incubation had a dedicated, purpose-built architectural setting, and that the sanctuary chose to display cure records publicly within it — an institutional decision about publicity, not a neutral archive.",
        detail:
  ...
  },
  {
    ...
    keyPoints: [
      {
        claim: "An Athenian priestess held office for life, that her sixty-four years of service were recorded on the stone of a portrait statue set up by her own family, and that she was independently notable enough for a Roman encyclopaedist to record a sculptor's portrait of her centuries later.",
        detail:
      ...
      {
        claim: "The priesthood occupied a large, prominent residence at the centre of the city and that its senior members were publicly honoured by name with statues — visible institutional standing, not a cloistered existence.",
        detail:
      ...
      {
        claim: "A woman holding a civic priesthood could fund a major public building in her own name and be honoured for it by an organised trade group — religious office functioning as a channel for female public benefaction.",
        detail:
      ...
      {
        claim: "Custody of a sanctuary was an emblem chosen for permanent commemoration in death, i.e.",
        detail:
  ...
  },
  {
    ...
    keyPoints: [
      {
        claim: "The stone carries two decrees of different dates rather than one design: the earlier creates the priesthood and provides for selection by lot from the whole body of Athenian women, with fifty drachmas and portions of the public sacrifices; the later, conventionally dated 424/3, instructs the city's payment officers to make the payment.",
        detail:
      ...
      {
        claim: "In Hellenistic Ionia priesthoods were auctioned by the city as revenue-bearing assets, with the terms of purchase and the buyer's perquisites published on stone.",
        detail:
      ...
      {
        claim: "Priestly office carried a reserved public seat, physically marking rank in a civic space; the throne of the priest of Dionysos Eleuthereus is the most elaborate.",
        detail:
  ...
  },
  {
    ...
    aitia: [
      ...
      },
      {
        ...
        note:
          "The earliest source we can reach for the story is Theophrastus, roughly a century after the classical rite, and we reach him only through Porphyry six centuries later, quoting him inside an argument against animal sacrifice. The story explains the ritual's oddity; it does not date or cause it.",
      },
      {
    ...
    keyPoints: [
      {
        claim: "A deme's religious year was recorded as a costed schedule — date, recipient, victim, ritual qualification, price — with the year's obligations apparently distributed across five roughly balanced blocks of expenditure.",
        detail:
      ...
      {
        claim: "The state calendar was physically redrafted at the end of the fifth century and then altered again, leaving on the stone itself the trace of a political fight over sacred expenditure.",
        detail:
      ...
      {
        claim: "A second, independent deme schedule lists month-by-month sacrifices and recipients, confirming that the Erchia stele represents a normal local practice rather than a unique document.",
        detail:
          "Sacrificial calendar of the deme Thorikos (SEG 33.147) (Thorikos, southeast Attica).",
        level: "documented",
      },
      {
        claim: "A grouping of demes maintained a joint schedule alongside its members' own, evidencing several overlapping layers of calendrical obligation within Attica.",
        detail:
    ...
    terms: [
      { term: "month names (menes)", gloss: "Greek months were named for festivals falling in them, so that the calendar and the festival programme were the same list; the names differed from city to city, which is why cross-city dating required more than one system." },
      { term: "hemera", gloss: "A day of the Athenian month, counted in three decads, the last of which was counted backwards; a decree date is a day of a named month in one system and a day of a prytany in the other." },
  ...
  },
  {
    ...
    howItWorked: [
      ...
      "At Eleusis the documented sequence stops. Initiates entered the Telesterion at night; the uninitiated did not. The building's stepped interior, and the central structure the excavators identified as the anaktoron, establish the physical arrangement as they reconstructed it, and later sources refer in general terms to things said, things done and things shown. What those were is not recorded by any source that was inside and bound by the prohibition. The sanctuary also contained a cave shrine identified as a Ploutonion. Torches are pervasive in the cult's iconography and in the literary sources, which is the basis for supposing night-time performance; the excavated material does not by itself establish when the rite took place, and neither the cave nor the torches recovers a sequence of events.",
    ...
    silences: [
      "What was shown, said or done inside the Telesterion is not recorded. This is not a gap caused by loss: the classical sources knew and chose not to write it, and the prohibition was legally enforced. No account of the revelation survives from anyone who can be shown to have been inside. Late pagan writers gesture at its effect without describing it; the only texts that name a specific object or act are Roman-imperial and Christian, written by outsiders, and the most circumstantial of them are polemicists arguing that pagan initiation was disreputable.",
    ...
    keyPoints: [
      {
        claim: "The central rite required a very large audience to be admitted indoors at once and oriented toward a focal point, and, on the excavators' reconstruction, that a focal structure was preserved through successive rebuildings — architecture that frames the event without disclosing it.",
        detail:
      ...
      {
        claim: "Athens levied a fixed fraction of the barley and wheat harvest for the Eleusinian goddesses, extended the obligation to its allies and invited other Greeks to join — the Mysteries as a taxed and administered institution.",
        detail:
          "The stele of the first-fruits decree (IG I³ 78/78a), later fifth century BC (Eleusis / Athens).",
        level: "documented",
      },
      {
        claim: "Eleusinian iconography had a settled visual language of approach, reception and torch-lit procession — and stops there.",
        detail:
          "Painted votive plaque dedicated by Ninnion, showing figures approaching Demeter and Kore with torches, around the early fourth century BC (From Eleusis; National Archaeological Museum, Athens). The plaque does not depict the central rite, and reading one into it requires importing a description from elsewhere.",
        level: "probable",
      },
      {
        claim: "A mystery sanctuary kept and published an administrative record of who was initiated, with dates — proof of the institution's bureaucratic normality and, again, complete silence on content.",
        detail:
      ...
      {
        claim: "A chthonic focus existed within the sanctuary precinct and was monumentalised.",
        detail:
    ...
    primarySources: [
      ...
      },
      {
        ...
        locus: "8.65",
        author: "Herodotus",
        summary: "Tells a portent story: with Attica evacuated during the Persian occupation, two men on the empty Thriasian plain saw a great dust cloud and heard the Iacchos cry, and took it for a divine sign precisely because no one remained to hold the procession. The episode reports a marvel, not a celebration, but it assumes readers for whom the sight and sound of the Eleusinian procession were instantly identifiable.",
      },
      {
        work: "History of the Peloponnesian War",
        locus: "6.27–28",
  ...
  },
  {
    ...
    whatIsAttested: [
      ...
      "Hero cult was also an instrument of civic politics, and here the evidence is unusually good because the political act is sometimes datable. Thucydides reports that after Brasidas died at Amphipolis in 422 BCE the city buried him inside the walls, fenced his tomb, sacrificed to him as a hero, and gave him annual games and sacrifices, transferring to him the title of founder and dismantling the memorials of the Athenian Hagnon who had actually founded the place. Herodotus tells a story of Sparta, stalled in its war with Tegea, recovering the bones of Orestes on oracular instruction and prospering afterwards; he was writing generations later, and the story has the shape a tradition acquires once the outcome is known, so it belongs with the stories told about relic transfer rather than with the datable cases. The Brasidas episode is different in kind: Thucydides was a contemporary, and what he records is a decree and a set of standing observances rather than a reversal of fortune. They demonstrate the mechanism: a hero could be created, imported, relocated, or replaced when a city's needs changed.",
    ...
    keyPoints: [
      {
        claim: "By the mid-seventh century a Laconian community was making an inscribed dedication at this hill to a figure known from epic — a single dedication, to Helen, and one whose text is partly restored, so the finding is no firmer than the restoration.",
        detail:
      ...
      {
        claim: "A hero could operate as a full healing and oracular sanctuary with staff, revenue and formal procedure, and that such sites generated substantial documentation while ordinary hero shrines did not.",
        detail:
  ...
  },
  {
    ...
    keyPoints: [
      {
        claim: "Cities invested in permanent, competitive, individually branded storage and display at panhellenic sanctuaries.",
        detail:
      ...
      {
        claim: "A classical temple functioned substantially as a strongroom, with named rooms serving as discrete accounting units, and the architecture and the documents can be mapped onto one another for those rooms whose identification is secure.",
        detail:
      ...
      {
        claim: "Stone offertory boxes provided a routine mechanism for small cash income from ordinary visitors, distinct from formal dedication.",
        detail:
      ...
      {
        claim: "The stelai record itemised construction finance — contracts, contractors, guarantors, payments — for a major sanctuary building programme, and give unit costs for labour and materials at a specific place and period.",
        detail:
    ...
    primarySources: [
      ...
      {
        work: "Delphic building and administrative accounts of the fourth and third centuries (CID II)",
        locus: "CID II",
  ...
  },
  {
    ...
    period: "Archaic Greece – Roman imperial period",
    whatIsAttested: [
      "Extispicy was the routine, expected form of Greek divination on campaign, and the Roman equivalent before public business was the taking of auspices by the magistrate himself; neither is what the literary tradition preserves best. A seer killed an animal, examined the liver and other organs, and pronounced the signs favourable or not; where they were not, the sacrifice was often repeated, though Xenophon also records days of repeated sacrifice that never came out favourable and an operation abandoned in consequence. Armies did this before marching, before crossing a river, and again immediately before engagement. Xenophon, who commanded and who describes the procedure repeatedly from inside it, treats the pre-battle sacrifice as an ordinary operational step with a professional attached to the staff, and records the pay involved: Cyrus gave the Ambraciot seer Silanos three thousand darics for having correctly told him, eleven days earlier, that the King would not fight within ten days. That single notice tells us more about the economics of the profession than any oracle story.",
    ...
    howItWorked: [
      ...
      "Consulting an institutional oracle involved fees, queueing and priority: enquirers paid before consultation, and the right to consult ahead of others could be granted to a city or an individual as a standing honour. The procedural detail commonly repeated in modern summaries comes from late and partly reconstructive authors, and the consultation procedure of any single sanctuary belongs with that sanctuary rather than with divination as a technique. At Dodona the mechanism is better evidenced by the material itself: the enquirer wrote a question on a small lead strip, folded it, and submitted it; some strips carry a short reply, but most preserve only the question — which makes this the one substantial body of oracular evidence not shaped by knowing how things turned out.",
    ...
    keyPoints: [
      ...
      {
        claim: "Etruscan haruspicy operated on a systematic correspondence between marked regions of the organ and named deities, organised in sixteen divisions.",
        detail:
      ...
      {
        claim: "Bird-observation was embedded in a written, prescriptive Italic ritual procedure with named directions, stations and formulae — an Italic counterpart to Roman augural practice documented from outside Rome and outside Latin.",
        detail:
    ...
    disputes: [
      {
        question: "How much interpretive latitude did a battlefield seer actually have?",
        positions:
          "Xenophon writes from inside the practice and presents the seer's reading as a technical finding that constrained the commander, with operations delayed and abandoned on unfavourable signs. Against that, the repeatability of the sacrifice and the seer's dependence on the commander who paid him have been read as leaving wide room for a reading that suited the moment, so that divination functioned to license decisions already taken. The evidence is almost entirely narrative and written by participants with an interest in how the episode is remembered, and it does not settle the question.",
        level: "disputed",
      },
      {
        question: "How much of the oracular tradition preserved in narrative sources is authentic?",
        positions:
          "Fontenrose's 1978 catalogue sorted responses into historical, quasi-historical, legendary and fictional, and argued that those attested as genuinely historical are overwhelmingly plain commands and sanctions on cultic matters, while the ambiguous and spectacular predictions cluster in the legendary and quasi-historical classes — including many famous ones usually treated as authentic. Earlier scholarship accepted a far larger proportion as genuine. The disagreement matters for this page because it is a disagreement about the whole class of retrospectively-narrated response, not about any one sanctuary.",
        level: "disputed",
      },
      {
        question: "Was the demand for divination met by a profession or by an occupation?",
        positions:
          "Named seers appear with family traditions, fees and reputations that travelled, which has been read as evidence of a recognised specialism with something like a career structure. Others read the same material as showing an occasional occupation practised alongside others, visible in the record only when a war or a famous consultation preserved a name. The prosopography is too thin to decide, and the surviving names are heavily skewed toward men attached to armies and to well-documented campaigns.",
        level: "disputed",
      },
    ],
  ...
  },
  {
    ...
    aitia: [
      ...
      },
      {
        ...
        source: "Related by Livy in book 1 and referred to by Cicero in De divinatione; a statue of Navius was said to stand at the Comitium.",
        note:
    ...
    keyPoints: [
      ...
      {
        claim: "The augurate had a fixed, publicly recognised visual signature used for self-advertisement by office-holders.",
        detail:
    ...
    disputes: [
      ...
      {
        question: "Does the frequency of obnuntiatio in the 50s BC show the procedure being used instrumentally, or only that our sources for those years are political ones?",
        positions:
  ...
  },
  {
    ...
    aitia: [
      {
        ...
        source: "Cicero reports it at De divinatione 2.50-51, inside his own refutation of divination, and it recurs in later authors including Ovid and Festus. Cicero is writing in the 40s BC about a revelation placed in an undated Etruscan past.",
        note:
    ...
    keyPoints: [
      {
        claim: "Etruscan liver-divination worked by partitioning the organ into named divine regions — the single strongest piece of direct evidence for the practice, and simultaneously the clearest demonstration of how little a map conveys without a manual.",
        detail:
      ...
      {
        claim: "The stone is compatible with the office having had an indigenous Etruscan name, and with lightning being a titled specialism.",
        detail:
      ...
      {
        claim: "A codified iconography of liver-inspection existed in Etruscan art by about 400 BC, some three centuries before the Piacenza liver — attached, on this object, to a Greek mythological seer rather than to a named Etruscan practitioner.",
        detail:
      ...
      {
        claim: "The practitioner had a distinctive costume, making the office visually identifiable in Etruscan society.",
        detail:
      ...
      {
        claim: "Modelled livers as divinatory instruments existed in the Near East long before the Etruscan examples, which is the empirical basis for the diffusion hypothesis — and no more than the basis.",
        detail:
    ...
    primarySources: [
      ...
      {
        work: "De divinatione",
        locus: "book 1.92 for the branches of the discipline and the training of Etruscan nobles; book 2.50-51 for the Tages story, told inside the sceptical refutation; 2.28-41 for the attack on extispicy",
        author: "Cicero",
        summary: "Reports at 1.92 that the Senate of an earlier generation decreed that sons of leading Etruscan families be trained in the discipline so that it should not pass from religious authority into trade; preserves the origin myth of Tages in the second book, where it is recounted inside the sceptical refutation rather than offered as doctrine; and attacks extispicy on the ground that the state of an animal's organs has no connection to human affairs.",
      },
      {
        work: "Annals",
        locus: "11.15",
  ...
  },
  {
    ...
    silences: [
      "There is no surviving record of a vow that went unanswered. The votive dedications are, as a class, records of debts paid — the discharge is what produced the object — so the practice's actual success rate, and what Romans did when a god did not deliver, are structurally invisible. The Arval Acts are the exception that proves the shape of the gap: they record vows pronounced as well as vows discharged, and never a vow that failed.",
    ...
    keyPoints: [
      {
        claim: "The vow-and-discharge cycle was an archived state liturgy with a fixed annual date, recorded in enough procedural detail to reconstruct the sequence of acts.",
        detail:
      ...
      {
        claim: "A conditional vow followed by a recorded payment was a standard mode of individual religious action, uniform in structure across the empire.",
        detail:
      ...
      {
        claim: "Annual vows for the ruler on 3 January were prescribed in the religious calendar of one unit on the eastern frontier — the only direct evidence that the Roman cycle was written into a garrison's year away from Rome, and a single document, not a demonstration of empire-wide uniformity.",
        detail:
    ...
    primarySources: [
      ...
      },
      {
        ...
        locus: "9, 11-12 (vows for the emperor's health; monuments voted on his safe return)",
        author: "Augustus",
        summary: "Records that the senate decreed vows for his health to be undertaken every fifth year by the consuls and the priests, and that games were repeatedly held in fulfilment of them by the chief priestly colleges or by the consuls; and that on his safe return the senate consecrated an altar of Fortuna Redux and voted further honours — an official first-person statement of the vow cycle at the top of the state.",
      },
      {
  ...
  },
  {
    ...
    howItWorked: [
      ...
      "On the day the army and the spoils assembled in the Campus Martius. On the usual modern reconstruction the procession enters the city, passes the Circus Flaminius and the Circus Maximus — which offered seated viewing — then goes along the Sacra Via and up the Capitoline to sacrifice at the temple of Jupiter Optimus Maximus. The Circus Flaminius leg is disputed, with an alternative running by way of the Forum Boarium, and no ancient source states the itinerary or the reason for it. Carried in the procession were captured objects and money, painted boards and models identifying places and events, sacrificial animals with gilded horns, prisoners of rank, the magistrates and senate, and the celebrant in a four-horse chariot wearing purple-and-gold ceremonial dress. His soldiers followed. Josephus's account of AD 71 shows the Capitoline arrival functioning as the ceremony's hinge: the procession waited there for a specific piece of news before the sacrifice proceeded.",
      "Cost and personnel were substantial and are recorded only in fragments. The senate voted a sum; the commander also disposed of manubiae, the proceeds of the sale of booty, from which triumphators built temples and made donatives to their troops — Livy gives per-head payments for particular triumphs. Public feasting and games could follow.",
    ],
    evidenceBase: [
      {
        kind: "inscription",
    ...
    keyPoints: [
      {
        claim: "The triumph was an officially registered institution with a canonical list, displayed publicly in the Forum Romanum on a monument that is not securely identified.",
        detail:
          "Fasti Triumphales, inscribed marble panels (found 1546 in the Forum) (Palazzo dei Conservatori, Capitoline Museums, Rome). The list supplies chronology, categories such as the Alban Mount triumph, and the state's own account of its past.",
        level: "probable",
      },
      {
    ...
    primarySources: [
      {
        ...
        locus: "7.123-157 (the triumph of Vespasian and Titus, AD 71)",
        author: "Josephus",
  ...
  },
  {
    ...
    keyPoints: [
      ...
      {
        claim: "The painted figures correspond to a widely produced statuette type, and that households owned portable images matching the wall paintings.",
        detail:
          "Bronze statuettes of Lares with drinking horn and situla, from Pompeian houses (Museo Archeologico Nazionale, Naples).",
        level: "probable",
      },
      {
        claim: "Household cult installations were sited in working areas as well as in display rooms, and that a single house could have several.",
        detail:
    ...
    primarySources: [
      ...
      {
        work: "Satyrica",
        locus: "60.8, with the atrium shrine at 29",
        author: "Petronius",
        summary: "Two boys set bulla-wearing Lares on the table while a third carries round a bowl of wine; the host gives the household gods joke names (Cerdo, Felicio, Lucrio) and an image associated with him is passed round. The silver Lares belong to a different passage, in the description of the shrine in his atrium.",
      },
      {
        work: "Fasti",
  ...
  },
  {
    ...
    aitia: [
      ...
      },
      {
        ...
        source: "Ovid, Fasti book 2.",
        note:
          "Ovid tells this story once, and makes it explain two unrelated things at the same time — the silent goddess of the rite and the parentage of the Lares — which shows him working a motif rather than transmitting an authoritative tradition.",
      },
    ],
    keyPoints: [
      {
      ...
      {
        claim: "The tomb was a legally defined and defended piece of property, and that dedication to the Manes became a near-universal formula in the imperial period.",
        detail:
  ...
  },
  {
    ...
    keyPoints: [
      {
        claim: "The Senate legislated on cult for allied Italy in 186 BCE and had its order permanently inscribed and displayed in a provincial community; it also fixes the decree's actual contents independently of Livy.",
        detail:
      ...
      {
        claim: "An imported eastern deity received a monumental, centrally located, state-sponsored sanctuary with successive rebuilding phases, confirming the reality of front-door admission.",
        detail:
      ...
      {
        claim: "A festival attached to an imported cult was still a fixed public date in the Roman civic year more than five centuries after its introduction.",
        detail:
  ...
  },
  {
    ...
    howItWorked: [
      ...
      "The core regular activity was a meal taken reclining on the two benches, facing the cult relief and each other. The meal is visible in the debris — bone, cooking and serving vessels, hearths — but its scale and cost are not recoverable, and the assemblages vary by site. Some mithraea show deliberate decommissioning in the fourth century — images defaced, altars overturned, deposits sealed — but whether a given case reflects Christian violence, official closure, or an act by the members themselves has to be argued site by site and often cannot be decided.",
    ],
    evidenceBase: [
      {
        kind: "archaeology",
    ...
    keyPoints: [
      ...
      {
        claim: "An individual soldier's career carried the cult across the empire, and that the dedicator recorded where he had been made — a rare glimpse of a member's personal trajectory through the cult.",
        detail:
      ...
      },
      {
        ...
        detail:
          "Large ceramic 'snake vessel' with applied relief figures, recovered in 1976 from unsupervised construction work on the Ballplatz site and restored in 1980-81, published in 1994 (Mainz (Mogontiacum)).",
        level: "probable",
      },
    ],
    terms: [
      ...
      { term: "tauroctony", gloss: "The bull-slaying image, with its fixed cast of subsidiary figures, set in or above the niche at the end of the hall. It is the standard cult image wherever one survives, though many identified mithraea preserve none. It is the cult's central statement about itself and its meaning is not explained by any ancient source." },
  ...
  },
  {
    ...
    whatIsAttested: [
      ...
      "The theology the cult presented to the Greek-speaking world survives in a distinctive documentary form: the aretalogy, a first-person text in which the goddess enumerates what she is and what she has done. In the commonest form the goddess speaks in the first person; versions are inscribed at Kyme, Ios, Thessalonica and Andros, and the Maroneia text is an address to her by a dedicant rather than a self-declaration and elsewhere; the Kyme and Maroneia texts are the best preserved. Two of them claim to reproduce a stele standing before the temple of Ptah at Memphis, and Diodorus Siculus quotes a closely comparable self-declaration which he places on stelae at Nysa, not at Memphis. Across these the goddess claims universal scope — invention of writing, establishment of law, separation of heaven and earth, power over fate and over the sea. Whatever their relation to any actual Egyptian original, these are inscriptions, publicly displayed, produced by Isiac communities themselves. They are the closest thing to a doctrinal statement the cult has left, and they are strikingly unlike a mystery text: they are addressed outward.",
    ...
    silences: [
      "No liturgical text from an Isiac sanctuary in the Roman world survives — no order of service, no prayer as recited, no hymn as sung in a Roman Iseum. No liturgical text from an Isiac sanctuary in the Roman world survives — no order of service, no prayer as recited, no hymn as sung in a Roman Iseum. A daily service is described only by Apuleius, in a novel.",
    ...
    keyPoints: [
      ...
      {
        claim: "Funding an Isiac temple was a recognised route to municipal honour for a wealthy freedman family, and that the cult was thoroughly integrated into the civic honours system.",
        detail:
      ...
      {
        claim: "Isidis Navigium (5 March), Isia (28 October to 1 November), Hilaria (3 November) and Serapia (25 April) were fixed dates in the public Roman year in the mid-fourth century.",
        detail:
  ...
  },
  {
    ...
    keyPoints: [
      {
        claim: "The ground area given over to storage at a single royal foundation vastly exceeded its ritual space, and that grain and goods handling was the physical bulk of the institution.",
        detail:
      ...
      {
        claim: "Temple endowments needed enforceable legal protection against state officials, and that the crown was prepared to publish that protection monumentally far from the foundation itself.",
        detail:
  ...
  },
  {
    ...
    standfirst:
      "A trade with workshops, contracts and heritable rights. The famous description of its grades of service was written by a Greek visitor working through interpreters.",
    description:
    ...
    silences: [
      "No full technical manual survives from the New Kingdom, the period whose mummies are the most familiar. The embalming section on the reverse of Papyrus Louvre-Carlsberg (c. 1450 BC) is a few columns inside a medical manuscript, and nothing else from the period describes the procedure; the peak of the practice is documented by its products and almost not at all by its procedures.",
    ...
    aitia: [
      ...
      {
        story: "Funerary literature explains the retention of the heart by its role in the judgement of the dead (treated in full on the Egyptian afterlife page), and equips it with a scarab inscribed with a spell instructing it not to testify against its owner.",
        ...
        source: "Book of the Dead spells for the judgement scene and for the heart scarab (conventionally chapters 125 and 30B), New Kingdom and later.",
        note:
    ...
    keyPoints: [
      ...
      {
        claim: "A compound balm of plant oil, heated conifer resin, aromatic plant extract and plant gum was applied to funerary textiles in the Predynastic period, long before pharaonic mummification.",
        detail:
      ...
      {
        claim: "The identification of the officiant with Anubis may have been enacted physically, not only depicted; the object is real, the interpretation of its use is inference.",
        detail:
  ...
  },
  {
    ...
    silences: [
      ...
      "The annual throughput and seasonality of the operation are unrecorded. Estimates of millions are derived from gallery volume and deposit density, not from a count and not from any known span of years, so the rate at any given moment is unknown.",
    ...
    keyPoints: [
      {
        claim: "The burial of the single sacred bull was a state-scale undertaking, with quarrying, transport and gallery construction on a royal order of magnitude, sustained across many centuries.",
        detail:
      ...
      {
        claim: "Several species-specific cults operated side by side at one site, with their own galleries, their own personnel and, in the demotic ostraca from the same excavations, their own paperwork.",
        detail:
      ...
      {
        claim: "The unique-animal model was replicated at other cult centres with its own dated stelae series, confirming the Apis arrangement was a pattern rather than a Memphite peculiarity.",
        detail:
    ...
    primarySources: [
      ...
      },
      {
        ...
        summary: "Includes an official inquiry into abuses in the ibis cult: a malpractice said to have run for thirty-two years, the arrest of six men, and a remedy requiring one god in one vessel. The text does not state what the abuses were. Alongside it stand letters, dream reports and administrative memoranda concerning the running of the cult.",
      },
      {
  ...
  },
  {
    ...
    howItWorked: [
      ...
      "Purity governed the whole system, and the elaborate purity code — regulations on corpse contact, the ritual bath, the dog's gaze at the bier, the treatment of bodily pollution — is set out in the Videvdad, a Young Avestan text of contested date. It prescribes. Corpse exposure followed by collection of the dry bones is independently attested by Herodotus for the magi and by ossuaries (astodans) excavated in Persis, Sogdia and Central Asia, so the general practice is real. But Achaemenid kings were laid in rock-cut tombs at Naqsh-e Rustam and Persepolis, and Cyrus in a built tomb at Pasargadae. Whether those bodies were exposed first — as the ossuary practice would allow — or treated some other way is not recorded; Herodotus says Persians other than the magi coated the body in wax before burial. Royal practice cannot be read off the rite the magi are described as following.",
    ],
    evidenceBase: [
      {
        kind: "inscription",
        note: "Achaemenid royal inscriptions in Old Persian (Bisotun, Naqsh-e Rustam, Persepolis) name Ahuramazda persistently and record the suppression of a daiva sanctuary; the kingship theology they express is treated on the Behistun page. Sasanian Middle Persian inscriptions, above all Kartir's four, give a priest's own account of institutional religion.",
        limits:
      ...
      },
      {
        ...
        limits:
          "Accounting records name transactions, not rites. They do not describe what any ceremony consisted of, who attended, what was said, or what anyone thought it accomplished. Coverage is the Persepolis region and its routes toward Elam, over some sixteen years, and the archive remains only partly published.",
      },
      {
        kind: "literary",
    ...
    keyPoints: [
      {
        claim: "Achaemenid state administration funded a plural cult economy in Persis in the years around 509–493 BCE, with Ahuramazda among Elamite and Semitic deities, and that priestly officiants were salaried functionaries within the imperial system.",
        detail:
          "The Persepolis Fortification Archive: thousands of Elamite administrative tablets, 2,087 published by R. T. Hallock in 1969, recording commodity disbursements including rations issued for cultic purposes, with named deities, named ceremonies and named classes of officiant. (Excavated at Persepolis, Fars, in the 1930s; divided between institutional collections in Chicago and Iran, with large-scale return to Iran ongoing.).",
        level: "documented",
      },
      {
        claim: "An Achaemenid royal inscription can call a rival a magus (Gaumata) — the earliest datable Iranian use of the term, and evidence that the title was publicly legible in the sixth century BCE.",
        detail:
      ...
      {
        claim: "A formal open-air installation, generally but not universally read as cultic, stood in the earliest Achaemenid capital.",
        detail:
      ...
      {
        claim: "Royal worship before an elevated fire was a public image the Achaemenid monarchy chose for its most permanent monument, and that this posture persisted on later royal tombs at the same site.",
        detail:
    ...
    terms: [
      ...
      { term: "barsom", gloss: "A bundle of rods, originally plant stems and later metal wires, held and manipulated by the officiating priest through the service. Strabo, writing under Augustus, describes something answering to it, which is the earliest external attestation." },
  ...
  },
  {
    ...
    howItWorked: [
      ...
      "Festivals moved the god out of the house. Processions carried statues along prescribed routes, divine statues were carried by river barge to visit the gods of other cities, and the akītu festival, best known from Babylon, involved the god leaving the temple for a festival house outside the city and returning. The ritual texts for the Babylonian akītu survive in fragmentary late copies, and the celebrated elements — the king's humiliation before the god, the recitation of Enuma Elish — come from those late and incomplete tablets, not from a continuous record of performance. What the ceremony looked like in the second millennium, or in any specific year of the first, is not documented.",
    ],
    evidenceBase: [
      {
        kind: "documentary",
        note: "Institutional archives on clay: Ebabbar at Sippar (c. 30,000 tablets, chiefly sixth to early fifth century) and Eanna at Uruk (c. 8,000–9,000, largely seventh to fifth century), the Early Dynastic Bau archive from Girsu, and the Ur III administrative corpus. These record actual transactions with dates, names, quantities and prices.",
        limits:
    ...
    keyPoints: [
      ...
      {
        claim: "The office of entu-priestess of the moon god at Ur was held by a royal daughter, was housed in an identified residential and cultic building, and was commemorated in inscribed monuments — one of the few cases where a named cultic officeholder, a title, a building and an object all connect.",
        detail:
      ...
      {
        claim: "A major cultic office involved permanent residence within the sacred precinct, with domestic, administrative and funerary functions in one complex — the temple household as a literal household.",
        detail:
      ...
      {
        claim: "The construction and furnishing of a god's house was a ruler's principal public act, documented in extended literary form, and statues of the donor were installed inside the temple to stand perpetually before the god.",
        detail:
    ...
    terms: [
      ...
      { term: "širku", gloss: "An oblate: a person dedicated to a temple, whose labour belonged to the institution. At Neo-Babylonian Eanna in Uruk oblates were marked with a star, and there oblate status generated a great deal of litigation; the marking is not attested as a general feature of temple staffing." },
      { term: "mīs pî / pīt pî", gloss: "'Washing of the mouth' and 'opening of the mouth': the paired rites by which a newly made divine image was made fit to receive offerings and to be treated as the god's presence — what relation the tradition held the image to bear to the deity is disputed (see Contested points). Preserved in first-millennium recensions from Nineveh and Babylon." },
    ...
    primarySources: [
      ...
      },
      {
        ...
        locus: "unconfirmed for text and line references; the group is cited by cone and text number in the standard editions",
  ...
  },
  {
    ...
    keyPoints: [
      {
        claim: "The monumental Alexandrian Serapeum was constructed under Ptolemy III, with a named architect, and dedicated bilingually.",
        detail:
      ...
      {
        claim: "The pairing of Sarapis and Isis with the reigning royal couple was formalised in official foundation practice, and the dynasty continued to build for the god after Ptolemy III.",
        detail:
      ...
      {
        claim: "The cult of Osiris-Apis was long established, monumentally provisioned and continuously used at Memphis from the New Kingdom into the Ptolemaic period, and Greek forms were added to an existing Egyptian sanctuary rather than replacing it — the physical setting for the god's Hellenisation.",
        detail:
      ...
      {
        claim: "One cult's own account of its diffusion: private transmission through a Memphite priestly family, two generations of household worship, temple building authorised by a reported dream, and local legal opposition — with no royal involvement mentioned anywhere in the text.",
        detail:
      ...
      {
        claim: "A single recognisable image type governed representations of the god across centuries and provinces, and the type was thoroughly Greek in form despite the god's Egyptian name.",
        detail:
    ...
    terms: [
      ...
      { term: "Serapeum", gloss: "A sanctuary of Sarapis. The word covers three quite different things: the Memphite Apis catacomb complex at Saqqara, the monumental Ptolemaic and Roman temple at Alexandria, and the modest private-turned-public sanctuaries of the Aegean and Italy." },
